...
function Cover({
  ...
  return (
    <FallbackImage
      ...
      className="w-full aspect-[4/3] object-cover [mask-image:linear-gradient(to_bottom,black_92%,transparent)] [-webkit-mask-image:linear-gradient(to_bottom,black_92%,transparent)]"
    />
  )
}
