  ...
  return (
    <div data-component="SaleItemDetailPage" className="flex flex-col min-h-dvh bg-surface-page">
      ...
      <CoverWithRibbon
        ...
        alt={item.name}
      />
      <div data-component="InfoPanel" className="mx-3 -mt-4 bg-surface-card rounded-2xl shadow-[0_4px_20px_rgba(255,255,255,0.5)] ring-1 ring-black/5 relative z-10 p-5 space-y-4">
        <div>
      ...
      <div className="flex-1 mx-3 mt-3">
        <section data-component="ContentSection" className="bg-surface-card rounded-2xl shadow-[0_4px_20px_rgba(255,255,255,0.5)] ring-1 ring-black/5 p-5">
